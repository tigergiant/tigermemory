...
The module counts new lessons, guard rejects, lesson references, preflight
hits, inbox backlog, and guard/tool commits for one month, then renders or
updates the metrics markdown table.
"""
