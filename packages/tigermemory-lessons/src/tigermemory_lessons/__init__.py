...
This package is intentionally lightweight and Python 3.10+ safe.
"""
...
def _configure_stdio() -> None:
    """Prefer UTF-8 output and avoid crashing on narrow Windows consoles."""
...
def main() -> None:
    _configure_stdio()
    p = argparse.ArgumentParser(prog="tigermemory-lessons", description=__doc__)
