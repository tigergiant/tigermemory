...
const target = process.argv[2]; // optional: "start" | "digest" | "health" | "quality" | "settings" | "agent-tools"
const pages = target ? [target] : ["start", "digest", "health", "quality", "settings", "agent-tools"];
